...
try {
	...
	$activar_desactivar="update usuarios SET estado_notificaciones_id_estado_notificacion=:valor WHERE usuarios.mail=:correo and estado_idEstado=1 ;";//ver aca por q la logica no funciona.
